    ...
    >
      ...
      <div className="p-4">
        <div className="flex items-center justify-between mb-2">
          <ViewTransition name={`property-price-${property.id}`}>
        ...
        <div className="flex items-center gap-4 text-xs text-gris">
          ...
          {property.rooms > 0 && (
            <span><i className="fa-solid fa-door-open mr-1 text-pm"></i>{property.rooms} amb</span>
          )}
          {property.bedrooms > 0 && (
            <span><i className="fa-solid fa-bed mr-1 text-pm"></i>{property.bedrooms} dorm</span>
          )}
          {property.bathrooms > 0 && (
            <span><i className="fa-solid fa-bath mr-1 text-pm"></i>{property.bathrooms}</span>
          )}
          {property.garage && (
            <span><i className="fa-solid fa-car mr-1 text-pm"></i>Coch.</span>
          )}
        </div>
        <Link
